        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-2">
          <div className="grid gap-3 md:grid-cols-3 lg:grid-cols-1">
            <a
              ...
              className="inline-flex min-h-[52px] items-center justify-start rounded-2xl border border-slate-200/70 bg-white/80 px-5 py-4 text-sm font-medium text-slate-800 transition hover:bg-slate-100 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-800"
            >
